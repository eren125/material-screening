...
df_vol['STRUCTURE_NAME'] = df_vol['STRUCTURE_NAME'].str.replace('Output/System_0/output_','',regex=False).str.replace('_1.1.1_298.000000_0.data:volume','',regex=False)
...
df_mat['STRUCTURE_NAME'] = df_mat['STRUCTURE_NAME'].str.replace('Output/System_0/output_','',regex=False).str.replace('_1.1.1_298.000000_0.data-','',regex=False)
...
df_frame['STRUCTURE_NAME'] = df_frame['STRUCTURE_NAME'].str.replace('Output/System_0/output_','',regex=False).str.replace('_1.1.1_298.000000_0.data:Framework','',regex=False)

...
df_box['STRUCTURE_NAME'] = df_box[0].str.replace('Output/System_0/output_','').str.replace('_1.1.1_298.000000_101300.data-','')
...
df_vol['STRUCTURE_NAME'] = df_vol['STRUCTURE_NAME'].str.replace('Output/System_0/output_','').str.replace('_1.1.1_298.000000_101300.data:volume','')
...
df_mat['STRUCTURE_NAME'] = df_mat['STRUCTURE_NAME'].str.replace('Output/System_0/output_','').str.replace('_1.1.1_298.000000_101300.data-','')
...
df_frame['STRUCTURE_NAME'] = df_frame['STRUCTURE_NAME'].str.replace('Output/System_0/output_','').str.replace('_1.1.1_298.000000_101300.data:Framework','')
